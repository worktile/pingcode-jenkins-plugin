...
public class WTLogger implements Serializable {
  ...
  public void error(String message) {
    this.listener.getLogger()
        .println("WT - [ERROR] This is probably a problem with worktile plugin, verbose information as blow");
    this.listener.getLogger().println("WT - [ERROR] " + message);
    this.listener.getLogger().println(
        "WT - [ERROR] please issue this problem at " + "https://github.com/worktile/wt-rd-jenkins-plugin/issues");
  }
}
